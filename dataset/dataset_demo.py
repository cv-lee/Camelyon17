...
SLIDE_PATH = '/mnt/disk3/interns/camelyon17/dataset/t_6.tif'
MASK_LV = 4
TISSUE_THRESHOLD = 0.4 # Train이 아니므로 큰값으로 설정
...
def make_tissue_mask(): 
    ...
    tissue_mask = slide.read_region((0,0), MASK_LV, slide.level_dimensions[MASK_LV])
    ...
    #cv2.imwrite('/home/interns/test/hitmap/tissue_mask/tissue_mask1.png',tissue_mask)
    return tissue_mask
