...
PATCH_PATH = '/mnt/disk3/interns/patch2/'
...
divide_patch(1,'train')
divide_patch(2,'train')
divide_patch(3,'f')
divide_patch(4,'train')
divide_patch(5,'train')
divide_patch(6,'f')
divide_patch(7,'f')
divide_patch(8,'train')
divide_patch(9,'train')
divide_patch(10,'f')
divide_patch(11,'train')
divide_patch(12,'f')
divide_patch(13,'train')
divide_patch(14,'f')
divide_patch(15,'train')
